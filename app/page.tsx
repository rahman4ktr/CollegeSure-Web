          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal direction="left" distance={40}>
              <div>
                ...
                <h2
                  id="inquiry-heading"
                  className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B3C5D] leading-tight mb-6 tracking-tight"
                >
                  Ready to Find Your{" "}
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <ScrollReveal key={item} direction="up" delay={idx * 0.1} distance={15}>
                      <div className="flex items-start gap-3.5 p-3 rounded-xl hover:bg-white/80 hover:shadow-sm border border-transparent hover:border-[#E2E8F0] transition-all duration-200">
                        <div className="w-7 h-7 rounded-lg bg-[#0D9488]/10 text-[#0D9488] flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm">
                          <CheckCircle2 size={16} />
                        </div>
                        <p className="text-sm text-[#0F172A] font-semibold pt-0.5">{item}</p>
                      </div>
                    </ScrollReveal>
                  ))}
                </div>
            ...
            <ScrollReveal direction="right" distance={40}>
              ...
              >
                <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-[#E2E8F0] p-6 sm:p-10 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-[#0D9488]/10 via-[#0B3C5D]/5 to-transparent rounded-bl-full pointer-events-none" />

                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0B3C5D] to-[#0D9488] text-white flex items-center justify-center shadow-md">
