                  ...
                  <ScrollReveal key={dept._id} delay={idx * 0.06} direction="up">
                    <div className="bg-white rounded-2xl border border-[#E2E8F0] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full group">
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        <h2 className="text-xl font-bold text-[#04164B] group-hover:text-[#0D9488] transition-colors mb-2">
                          {dept.name}
                        </h2>

                        {dept.description && (
                          <p className="text-sm text-[#475569] leading-relaxed line-clamp-3 mb-6 flex-1">
                            {dept.description}
                          </p>
                        )}
