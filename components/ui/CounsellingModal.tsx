      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl border border-white/60 overflow-hidden z-10 my-auto max-h-[92vh] flex flex-col"
          >
            {/* Mobile Drag Handle */}
            <div className="sm:hidden w-12 h-1.5 bg-[#E2E8F0] rounded-full mx-auto my-2.5 flex-shrink-0" />

            {/* Close Button */}
            <button
              onClick={() => !isSubmitting && onClose()}
              disabled={isSubmitting}
              className="absolute top-4 right-4 sm:top-5 sm:right-5 p-2.5 rounded-full text-[#475569] hover:text-[#04164B] hover:bg-[#F8FAFC] transition-colors z-30 disabled:opacity-30 cursor-pointer"
            ...
            <div className="overflow-y-auto flex-1">
              {!isSubmitted ? (
                <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[520px]">
                  ...
                  <div className="lg:col-span-5 bg-gradient-to-br from-[#04164B] via-[#040943] to-[#591084] p-6 sm:p-8 text-white relative overflow-hidden flex flex-col justify-between">
                    {/* Ambient Glow Orbs */}
                    <div className="absolute top-0 right-0 w-48 h-48 bg-[#159447]/20 rounded-full blur-2xl pointer-events-none" />
                    <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#B30F66]/20 rounded-full blur-2xl pointer-events-none" />

                    <div className="relative z-10 space-y-5">
                      {/* Live Status Badge */}
                      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-bold text-emerald-300">
                      ...
                      {/* Heading */}
                      <div>
                        <h3 id="modal-headline" className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                          How can we help you?
                        </h3>
                        <p className="text-xs sm:text-sm text-white/80 mt-2 leading-relaxed font-medium">
                      ...
                      <div className="bg-white/10 backdrop-blur-md rounded-2xl p-3.5 border border-white/15 text-xs space-y-1">
                        ...
                        <p className="text-[11px] text-white/70">
                          Counsellors active now on Phone &amp; WhatsApp.
                        </p>
                      </div>
                    ...
                    <div className="relative z-10 pt-6 border-t border-white/15 mt-6 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#159447] to-[#B30F66] flex items-center justify-center font-black text-sm shadow-md">
                          🎓
                        </div>
                        <div>
                          <p className="text-xs font-bold text-white">CollegeSure Guidance</p>
                  ...
                  {/* ── RIGHT SIDE — INSTANT MESSAGE FORM ─────────────────── */}
                  <div className="lg:col-span-7 p-6 sm:p-8 bg-white flex flex-col justify-between">
                    <div>
                      <div className="mb-5">
                        <h4 className="text-xl sm:text-2xl font-extrabold text-[#04164B]">
                          Send Us a Message
                        </h4>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-3.5">
                        {/* Full Name */}
                        <div>
                          <label className="block text-xs font-bold uppercase tracking-wider text-[#04164B] mb-1">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2">
                            <span className="inline-flex items-center px-3 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] text-xs font-bold text-[#04164B]">
                              🇮🇳 +91
                            </span>
                            <input
                              type="tel"
                        ...
                        <div>
                          <label className="block text-xs font-bold uppercase tracking-wider text-[#04164B] mb-1">
                            Email Address <span className="text-xs text-[#94A3B8] font-normal">(Optional)</span>
                          </label>
                          <input
                            type="email"
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl border border-[#E2E8F0] focus:border-[#B30F66] focus:ring-2 focus:ring-[#B30F66]/15 bg-[#F8FAFC]/50 text-sm outline-none font-medium text-[#04164B]"
                          >
                            ...
                            <option value="Placement Info">Placement Information</option>
                        ...
                        <button
                          type="submit"
                          disabled={isSubmitting}
                          className="w-full inline-flex items-center justify-center gap-2 bg-[#B30F66] hover:bg-[#591084] text-white font-extrabold py-3.5 rounded-xl shadow-lg shadow-[#B30F66]/20 transition-all text-sm hover:scale-[1.01] active:scale-95 disabled:opacity-50 mt-1 cursor-pointer"
                        >
                          {isSubmitting ? (
                    ...
                    <p className="text-center text-[11px] text-[#94A3B8] pt-2 font-medium flex items-center justify-center gap-1">
                ...
                <motion.div
                  ...
                  className="p-8 sm:p-12 text-center space-y-6 bg-white"
                >
                  ...
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-extrabold text-[#04164B] tracking-tight mb-2">
                      Message Sent Successfully!
                    </h3>
                    <p className="text-sm text-[#475569] font-medium max-w-md mx-auto leading-relaxed">
                      Thanks for reaching out. Our counselling team has received your message and will respond quickly.
                    </p>
                  </div>

                  {/* Live Status Badge */}
                  <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-3.5 max-w-md mx-auto inline-flex items-center gap-2.5">
                    <span className="relative flex h-3 w-3 flex-shrink-0">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-500" />
                    </span>
                    <span className="text-xs font-bold text-emerald-950">
                      Counsellor Support Available
                    </span>
                  </div>

                  <p className="text-xs font-bold uppercase tracking-wider text-[#94A3B8]">
                    You can also connect with us instantly:
                  </p>
                  ...
                  <div className="pt-4 border-t border-[#E2E8F0] flex items-center justify-center gap-4">
                    <button
                      onClick={handleReset}
